...
def setup_logger(outputfilename: Union[str, None] = None, loglevel: str = "INFO", disable_stderr: bool=False) -> None:
    ...
    logging.basicConfig(handlers=handlers, encoding='utf-8', level=get_log_level(loglevel), format=loggingformat, datefmt='%Y-%m-%d %H:%M:%S', force=True)
